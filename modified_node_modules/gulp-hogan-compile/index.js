...
module.exports = function(fileName, options) {
    ...
    function bufferContents(file) {
        ...
        compiledTemplate  = hogan.parse(file.contents.toString('utf8'), options.templateOptions);
        jsString = '    templates[\'' + templateName + '\'] = (' + JSON.stringify(compiledTemplate) + ');';
    ...
    function endStream(){
        ...
        if (options.wrapper === 'amd') {
            buffer.unshift("define([],function() {");
            buffer.push("})");
        }
        // CommonJS wrapper
