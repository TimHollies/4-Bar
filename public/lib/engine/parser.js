...
import { ABCLexer } from './lexer';
import { data_tables } from './data/data_tables';
import _ from 'lodash';

import { AbcNote, AbcRest, AbcSymbol } from './types/AbcSymbol';
import { AbcChord } from './types/AbcChord';
...
export function ABCParser(dispatcher, transposeAmount) {
    ...
    function processAddedLine(line) {
       ...
       // try {
            ...
            var lexed = ABCLexer(dispatcher, line.raw, line.id);
