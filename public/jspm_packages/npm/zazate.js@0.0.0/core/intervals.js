...
function determine(note1, note2, shorthand) {
  ...
  fifth_steps = [["unison", "1", 0], ["fifth", "5", 7], ["second", "2", 2], ["sixth", "6", 9], ["third", "3", 4], ["seventh", "7", 11], ["fourth", "4", 5]];
...
function from_shorthand(note, interval, up) {
  ...
  shorthand_lookup = [["1", major_unison, major_unison], ["2", major_second, minor_seventh], ["3", major_third, minor_sixth], ["4", major_fourth, major_fifth], ["5", major_fifth, major_fourth], ["6", major_sixth, minor_third], ["7", major_seventh, minor_second]];
  val = false;
  var shorthand,
      _i,
      _len;
